...
describe('The PikadayDirective:setDay is a method that \n', function() {
    ...
    it('should set date as today', () => {
        ...
        $scope.pikaday.setDay();
        $scope.$digest();

        expect($scope.pikaday.scope.date).toEqual(withControls);
