...
describe('The PikadayDirective:setWeekFromDate is a method that \n', function() {
    ...
    it('should set date to a week from now', () => {
        createController();
        ...
        $scope.pikaday.setWeekFromDate();
        $scope.$digest();

        expect($scope.pikaday.scope.date).toEqual(DateRange.weekFromNow(withControls));
    });
});
